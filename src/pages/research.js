    ...
    <Layout>
      ...
      <div style={{
        ...
        <ul style={{ marginLeft: `5%`, marginBottom: `1%` }}>
          ...
          <li style={{ color: `#a0ffe3` }}><a href="https://medium.com/coinmonks/size-does-matter-part-1-9f83b130a451">Size
            Does Matter: A Philosophy of Securities Laws for Tokenized
            Networks Part
            1</a></li>
          <li style={{ color: `#a0ffe3` }}><a href="https://medium.com/coinmonks/size-does-matter-part-2-fbcb20671b53">Size
            Does Matter: A Philosophy of Securities Laws for Tokenized
            Networks Part
            2</a></li>
          <li style={{ color: `#a0ffe3` }}><a href="https://medium.com/coinmonks/size-does-matter-part-3-b378244df7d5">Size
            Does Matter: A Philosophy of Securities Laws for Tokenized
            Networks Part
            3</a></li>
          <li style={{ color: `#a0ffe3` }}><a href="https://medium.com/coinmonks/size-does-matter-part-4-e66e2a242140/">Size
            Does Matter: A Philosophy of Securities Laws for Tokenized
            Networks Part
            4</a></li>
      ...
      <div style={{
        ...
        <ul style={{ marginLeft: `40px`, marginBottom: `5px` }}>
          <li style={{ color: `#a0ffe3` }}><a href="https://github.com/metacartel/MCV/blob/master/MCV-Whitepaper.md">MetaCartel
          ...
          <li style={{ color: `#a0ffe3` }}><a href="https://www.youtube.com/watch?v=hzbMPLxiht4">Drafting Wet Contracts
            in a
